...
### [What is an SSTable?](what-is-sstable.md)
...
### [Block-Based Storage](block-based-storage.md)
...
### [Compression Fundamentals](compression-fundamentals.md)
...
### [When to Use SSTables](when-to-use.md)
...
**New to SSTables?**
Start with [What is an SSTable?](what-is-sstable.md) to understand the basics.

**Want to understand the design?**
Read about [Immutability](immutability.md) and [Block-Based Storage](block-based-storage.md).

**Need performance insights?**
Check out [Bloom Filters](bloom-filters.md) and [Compression](compression-fundamentals.md).

**Ready to use them?**
Jump to [When to Use SSTables](when-to-use.md) for practical guidance.
