...
describe('Cross-Language Hash Parity', () => {
  ...
  describe('Edge cases from test vectors', () => {
    ...
    test('should handle UTF-8 keys (世界)', () => {
      const utf8Vector = vectors.key_hash_vectors.find((v: any) => v.key.includes('世界'));
    ...
    test('should handle emoji keys (🌍🚀)', () => {
      const emojiVector = vectors.key_hash_vectors.find((v: any) => v.key === '🌍🚀');
